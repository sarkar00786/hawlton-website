    ...
    const securityHeaders = [
      {
        ...
        value: `
          ...
          connect-src 'self' https://*.google-analytics.com https://*.googletagmanager.com https://*.googleadservices.com https://*.sanity.io https://fonts.googleapis.com https://fonts.gstatic.com https://vercel.live wss://ws-us3.pusher.com https://api.hawlton.com https://firestore.googleapis.com https://*.firebaseapp.com https://*.googleapis.com https://www.google.com data: blob:;
