    ...
    const securityHeaders = [
      {
        ...
        value: `
          ...
          connect-src 'self' https://*.google-analytics.com https://*.googletagmanager.com https://*.googleadservices.com https://*.sanity.io https://fonts.googleapis.com https://fonts.gstatic.com https://vercel.live wss://ws-us3.pusher.com https://api.hawlton.com https://firestore.googleapis.com https://*.firebaseapp.com https://*.googleapis.com https://www.google.com https://accounts.google.com https://oauth2.googleapis.com https://securetoken.googleapis.com https://identitytoolkit.googleapis.com data: blob:;
