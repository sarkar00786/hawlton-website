          ...
          <div className="container mx-auto px-4 sm:px-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center max-w-5xl mx-auto">
              <div className="text-left">
                <h3 className="text-2xl font-bold text-primary-navy mb-4">A Partnership for Growth</h3>
                <p className="text-primary-charcoal mb-4">
                  Our model is simple: you provide the quality products, and we build the digital and logistical framework to sell them nationwide. We invest in the platform, marketing, and delivery, so you can focus on what you do best.
                </p>
                <ul className="space-y-2">
                  <li className="flex items-center"><CheckCircle className="w-5 h-5 text-primary-gold mr-2" /> Your Expertise + Our Platform = Shared Success</li>
                  <li className="flex items-center"><CheckCircle className="w-5 h-5 text-primary-gold mr-2" /> Zero Upfront Cost for Digital Transformation</li>
                  <li className="flex items-center"><CheckCircle className="w-5 h-5 text-primary-gold mr-2" /> Nationwide Reach from Day One</li>
                </ul>
              </div>
              <div>
                <Image
                  src="/images/stock/group.jpg"
                  alt="A group of professionals collaborating on a project"
                  width={800}
                  height={600}
        ...
        <section className="py-12 sm:py-16 lg:py-20 bg-primary-white">
          <div className="container mx-auto px-4 sm:px-6">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center max-w-6xl mx-auto">
              ...
              <div>
                <Image
                  src="/images/stock/success.jpg"
                  alt="A successful business outcome"
                  width={800}
                  height={600}
                  className="rounded-lg shadow-lg"
                />
        ...
        <section id="market-data" className="py-12 sm:py-16 lg:py-20 bg-primary-white">
          <div className="container mx-auto px-4 sm:px-6">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center max-w-6xl mx-auto">
              ...
              <div>
                <Image
                  src="/images/stock/growth.jpg"
                  alt="A graph showing business growth"
                  width={800}
                  height={600}
                  className="rounded-lg shadow-lg"
                />
  ...
  <div className="container mx-auto px-4 sm:px-6">
    <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center max-w-6xl mx-auto">
      <div className="text-left">
        ...
        <p className="text-base sm:text-lg lg:text-xl text-primary-white/90 max-w-3xl">
      ...
      <div>
        <Image
          src="/images/stock/trust.jpg"
          alt="A symbol of trust and security"
          width={800}
          height={600}
          className="rounded-lg shadow-lg"
        />
