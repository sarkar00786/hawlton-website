...
const Button = forwardRef<HTMLButtonElement, ButtonProps>(
  ({
    ...
    const variantClasses = {
      primary: `bg-primary-gold text-primary-navy hover:bg-primary-gold/90 hover:shadow-[0_8px_32px_rgba(255,215,0,0.4)] hover:scale-[1.02] focus-visible:ring-2 focus-visible:ring-primary-gold focus-visible:ring-offset-2 shadow-[0_4px_16px_rgba(255,215,0,0.3)] active:scale-[0.98] transition-all duration-300 ease-out ${cornerClasses.primary}`,
      secondary: `bg-primary-navy text-primary-white hover:bg-primary-navy/90 hover:shadow-[0_8px_24px_rgba(26,58,95,0.4)] hover:scale-[1.02] focus-visible:ring-2 focus-visible:ring-primary-navy focus-visible:ring-offset-2 shadow-[0_4px_12px_rgba(26,58,95,0.2)] active:scale-[0.98] transition-all duration-300 ease-out ${cornerClasses.secondary}`,
